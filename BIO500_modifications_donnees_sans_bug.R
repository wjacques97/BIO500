...
collaborations$etudiant1 [collaborations$etudiant1 == "lespérance_laurie"]<- "lesperance_laurie"
collaborations$etudiant2 [collaborations$etudiant2 == "lespérance_laurie"]<- "lesperance_laurie"
